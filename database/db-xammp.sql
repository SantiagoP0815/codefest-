...
CREATE TABLE IF NOT EXISTS `p_login`.`posts` (
  ...
  PRIMARY KEY (`id_post`),
  INDEX `author_idx` (`author` ASC), -- Elimina "VISIBLE" de aquí
  CONSTRAINT `author`
    FOREIGN KEY (`author`)
...
CREATE TABLE IF NOT EXISTS `p_login`.`comments` (
  ...
  INDEX `post_id_idx` (`post_id` ASC), -- Elimina "VISIBLE" de aquí
  INDEX `c_user_idx` (`c_user` ASC), -- Elimina "VISIBLE" de aquí
  CONSTRAINT `post_id`
    FOREIGN KEY (`post_id`)
...
CREATE TABLE IF NOT EXISTS `p_login`.`likes` (
  ...
  INDEX `l_post_idx` (`l_post_id` ASC), -- Elimina "VISIBLE" de aquí
  INDEX `l_user_idx` (`l_user` ASC), -- Elimina "VISIBLE" de aquí
  CONSTRAINT `l_user`
    FOREIGN KEY (`l_user`)
    REFERENCES `p_login`.`users` (`u_id`)
    ON DELETE NO ACTION
...
CREATE TABLE IF NOT EXISTS `p_login`.`friend_request` (
  ...
  INDEX `f_sender_idx` (`f_sender` ASC), -- Elimina "VISIBLE" de aquí
  INDEX `f_receiver_idx` (`f_receiver` ASC), -- Elimina "VISIBLE" de aquí
  CONSTRAINT `f_sender`
...
CREATE TABLE IF NOT EXISTS `p_login`.`friends` (
  ...
  PRIMARY KEY (`id_friends`),
  INDEX `f_user_1_idx` (`f_user_1` ASC), -- Elimina "VISIBLE" de aquí
  INDEX `f_user_2_idx` (`f_user_2` ASC), -- Elimina "VISIBLE" de aquí
  CONSTRAINT `f_user_1`
...
CREATE TABLE IF NOT EXISTS `p_login`.`follow` (
  ...
  INDEX `f_follower_idx` (`f_follower` ASC), -- Elimina "VISIBLE" de aquí
  INDEX `f_followed_idx` (`f_followed` ASC), -- Elimina "VISIBLE" de aquí
